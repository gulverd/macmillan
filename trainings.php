...
<div class="container">
	...
	<h3 class="page-header">Training Sessions & Conferences</h3>
		<div class="col-md-1" id="padd">
			<div class="col-md-12 filter_menu" id="padd">
				<ul>
					<li><a href="#" class="years" id="all">All</a></li>
					<?php 
						$query2 = "SELECT DISTINCT year FROM trainings ORDER BY year DESC";
						$run2   = mysqli_query($conn,$query2);

						while($row2 = mysqli_fetch_array($run2)){
							$year   = $row2['year'];
							echo '<li><a href="#" class="years" id="'.$year.'">'.$year.'</a></li>';
						}
					?>
				</ul>
			</div>
